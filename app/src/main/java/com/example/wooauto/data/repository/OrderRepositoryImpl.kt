...
class OrderRepositoryImpl @Inject constructor(
    ...
    private var lastConfigSnapshot: WooCommerceConfig? = null
    ...
    private suspend fun getApi(config: WooCommerceConfig? = null): WooCommerceApi {
        ...
        val canReuseCachedInstance =
            cachedApiInstance != null &&
            lastConfigSnapshot != null &&
            actualConfig == lastConfigSnapshot &&
            (currentTime - lastConfigUpdateTime) < 300000
        
        if (canReuseCachedInstance) {
            return cachedApiInstance!!
        }
        
        cachedApiInstance = apiFactory.createApi(actualConfig)
        lastConfigSnapshot = actualConfig
