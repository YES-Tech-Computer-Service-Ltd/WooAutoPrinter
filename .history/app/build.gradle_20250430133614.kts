...
repositories {
    ...
    maven { url = uri("https://www.star-m.jp/repo/maven/") }
}
...
dependencies {
    ...
    implementation("com.starmicronics:stario10-android:1.8.0") // 安卓特定支持
    implementation("com.starmicronics:starxpandcommand:1.8.0") // StarXpand命令库
