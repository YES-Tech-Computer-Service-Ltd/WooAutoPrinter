...
interface ProductDao {
     ...
     * @return 产品列表流
     */
    @Query("SELECT * FROM products WHERE categories LIKE '%\"id\":' || :categoryId || '%'")
    fun getProductsByCategory(categoryId: String): Flow<List<ProductEntity>>

    @Query("SELECT * FROM products WHERE name LIKE :query OR sku LIKE :query OR description LIKE :query")
