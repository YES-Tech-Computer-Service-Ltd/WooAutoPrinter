        ...
        return Order(
            ...
            items = listOf(
                OrderItem(
                    ...
                    image = "",
                    options = listOf(
                        ItemOption("Main Course", "Grilled Salmon"),
                        ItemOption("Side Dish", "Roasted Vegetables"),
                        ItemOption("Drink", "Fresh Orange Juice")
                    )
                ),
                OrderItem(
                    id = 2,
                    ...
                    image = "",
                    options = listOf(
                        ItemOption("Type", "Ethiopian Single Origin"),
                        ItemOption("Size", "Large"),
                        ItemOption("Preparation", "French Press")
                    )
                )
            ),
            isPrinted = false,
            ...
            discountTotal = "5.00",
            feeLines = listOf(
                com.example.wooauto.domain.models.FeeLine(1, "Delivery Fee", "5.99", "0.60"),
                com.example.wooauto.domain.models.FeeLine(2, "Service Charge", "2.00", "0.20"),
                com.example.wooauto.domain.models.FeeLine(3, "Tip", "15.00", "0.00")
            ),
            taxLines = listOf(
