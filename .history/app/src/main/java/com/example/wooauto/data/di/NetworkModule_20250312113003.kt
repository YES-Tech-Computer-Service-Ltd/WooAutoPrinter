    ...
    companion object {
        ...
        fun provideOkHttpClient(authInterceptor: WooCommerceAuthInterceptor): OkHttpClient {
            ...
            return OkHttpClient.Builder()
                ...
                .connectionSpecs(listOf(connectionSpec, okhttp3.ConnectionSpec.COMPATIBLE_TLS, okhttp3.ConnectionSpec.CLEARTEXT))
