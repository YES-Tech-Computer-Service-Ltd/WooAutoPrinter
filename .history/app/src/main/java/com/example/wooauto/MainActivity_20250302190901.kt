...
class MainActivity : ComponentActivity() {
    ...
    private val requestPermissionsLauncher = registerForActivityResult(
        ...
        if (deniedPermissions.isEmpty()) {
            ...
            if (hasBluetoothDenied) {
                ...
                showPermissionSettings("蓝牙权限对于打印机功能至关重要，请在设置中手动开启")
            }
    ...
    private fun showPermissionSettings(message: String) {
        ...
        intent.putExtra(Settings.EXTRA_APPLICATION_DETAILS_DATA, Uri.fromParts("package", packageName, null))
        intent.putExtra(Settings.EXTRA_APPLICATION_DETAILS_DATA_STRING, message)
