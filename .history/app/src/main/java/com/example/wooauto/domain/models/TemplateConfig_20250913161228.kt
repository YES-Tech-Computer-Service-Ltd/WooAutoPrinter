...
data class TemplateConfig(
    ...
    // 商店信息样式
    val styleStoreInfoBold: Boolean = true,
    val styleStoreInfoLarge: Boolean = true,
    ...
    // 订单信息样式
    val styleOrderInfoBold: Boolean = false,
    val styleOrderInfoLarge: Boolean = false,
    ...
    // 客户信息样式
    val styleCustomerInfoBold: Boolean = false,
    val styleCustomerInfoLarge: Boolean = false,
    ...
    // 订单内容样式（主要作用于菜品名称与数量价格行）
    val styleOrderContentBold: Boolean = true,
    val styleOrderContentLarge: Boolean = true,
    
    // === 支付信息 ===
    // 是否显示支付信息
    val showPaymentInfo: Boolean = true,
    // 支付信息样式
    val stylePaymentInfoBold: Boolean = false,
    val stylePaymentInfoLarge: Boolean = false,
