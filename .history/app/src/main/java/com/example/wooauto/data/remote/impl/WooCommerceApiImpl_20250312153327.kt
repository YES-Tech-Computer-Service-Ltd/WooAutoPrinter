            ...
            val sslSocketFactory = object : SSLSocketFactory() {
                ...
                override fun createSocket(s: java.net.Socket, host: String, port: Int, autoClose: Boolean): java.net.Socket {
                    ...
                    try {
                        ...
                        // 禁用SNI，可能会导致一些Android 7设备的握手问题
                        val sniHostnameField = socket.javaClass.getDeclaredField("peerHostname")
                        sniHostnameField.isAccessible = true
                        sniHostnameField.set(socket, null)
                    } catch (e: Exception) {
