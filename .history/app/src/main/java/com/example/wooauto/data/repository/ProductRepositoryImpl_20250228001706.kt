...
import com.example.wooauto.data.local.entity.CategoryEntity
import com.example.wooauto.data.local.entity.ProductEntity
import com.example.wooauto.data.mapper.ProductMapper.toProduct
import com.example.wooauto.data.mapper.ProductMapper.toProductEntity
...
class ProductRepositoryImpl @Inject constructor(
    ...
    private suspend fun getApi(config: WooCommerceConfig? = null): WooCommerceApi {
        val currentConfig = config ?: settingsRepository.getWooCommerceConfig().first()
