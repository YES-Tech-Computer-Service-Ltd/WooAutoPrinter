...
fun OrderDto.processWooFoodInfo(): WooFoodInfo? {
    ...
    if (metaData == null) {
        ...
        return WooFoodInfo(
            ...
            Log.d("OrderDto", "订单#$number 返回默认WooFood信息: $it")
        }
    }
    
    Log.d("OrderDto", "订单#$number 元数据数量: ${metaData?.size}")
    ...
    return WooFoodInfo(
        ...
        Log.d("OrderDto", "订单#$number WooFood信息: $it")
    }
}

// 辅助函数：尝试多个可能的键名查找元数据值
private fun findMetadataValue(possibleKeys: List<String>): String? {
    // 遍历所有可能的键
