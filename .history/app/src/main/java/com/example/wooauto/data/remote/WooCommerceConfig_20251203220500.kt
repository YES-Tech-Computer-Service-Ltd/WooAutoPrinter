...
data class WooCommerceConfig(
    ...
    companion object {
        ...
        private fun maskValue(value: String): String {
            ...
            if (value.length <= 6) return value.take(2) + "***"
    ...
    private fun mask(value: String): String = Companion.maskValue(value)
    
    override fun toString(): String {
        return "RemoteWooCommerceConfig(siteUrl='$siteUrl', consumerKey='${mask(consumerKey)}', consumerSecret='${mask(consumerSecret)}', pollingInterval=$pollingInterval, useWooCommerceFood=$useWooCommerceFood)"
    }
} 