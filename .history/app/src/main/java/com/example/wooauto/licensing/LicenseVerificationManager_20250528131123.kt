...
class LicenseVerificationManager @Inject constructor(
    ...
    suspend fun forceServerValidation(context: Context): Boolean {
        return licenseManager.forceRevalidateAndSync(context)
    }
    ...
    companion object {
        ...
        fun staticForceServerValidation(
            ...
            getInstance().forceServerValidation(context)
        }
