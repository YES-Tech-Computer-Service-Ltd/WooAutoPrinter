                            ...
                            "general" -> {
                                ...
                                SettingsCategoryCard {
                                    ...
                                    SettingItem(
                                        ...
                                        subtitle = stringResource(id = R.string.keep_screen_on_title),
                                ...
                                "printing" -> {
                                    SettingsCategoryCard {
                                        ...
                                        SettingsNavigationItem(
                                            ...
                                            subTitle = run {
                                                val statusEnabledText =
                                                    stringResource(R.string.status_enabled)
                                                val statusDisabledText =
                                                    stringResource(R.string.status_disabled)
                                                val noTemplateSelectedText =
                                                    stringResource(R.string.no_template_selected)
                                                if (isAutoPrintEnabled) {
                                                    val currentSelectedTemplateTypeName =
                                                        defaultTemplateType.name
                                                    val templateName =
                                                        templates.find { it.id == currentSelectedTemplateTypeName }?.name
                                            ...
                                            isLocked = !hasEligibility,
                                            onClick = {
                                                if (hasEligibility) showAutomationSettingsDialog =
                                                    true else coroutineScope.launch {
                                                    snackbarHostState.showSnackbar(
                                                        licenseRequiredMessage
                                                    )
