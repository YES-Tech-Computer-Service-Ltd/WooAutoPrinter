    ...
    private fun ActiveOrderCard(
        ...
        Card(
            ...
            Column(
                ...
                val expectedTime = order.woofoodInfo?.deliveryTime
                val displayTime = if (!expectedTime.isNullOrBlank()) {
                    expectedTime
                } else {
                    java.text.SimpleDateFormat("MM-dd HH:mm", java.util.Locale.getDefault()).format(order.dateCreated)
                }
                ...
                val orderNote = order.notes.lines().filterNot { line ->
                    val trimmed = line.trim()
