...
class WooCommerceApiImpl(
    ...
    init {
        ...
        Log.d("WooCommerceApiImpl", "初始化WooCommerceApiImpl的OkHttpClient，使用简化的SSL配置")
        ...
        val sslContext = try {
            ...
            Log.e("WooCommerceApiImpl", "SSL上下文创建失败: ${e.message}")
            throw e
        }
        
        // 使用默认的ConnectionSpec，不过分指定
        val connectionSpec = okhttp3.ConnectionSpec.MODERN_TLS
