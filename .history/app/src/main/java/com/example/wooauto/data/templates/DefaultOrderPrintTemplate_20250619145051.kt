...
class DefaultOrderPrintTemplate @Inject constructor(
    ...
    private fun create58mmTestOrder(): Order {
        ...
        return Order(
            ...
            total = "$82.50",
            customerName = "张三",  // 中文客户姓名
            contactInfo = "138-1234-5678",  // 中文电话号码
            billingInfo = "北京市朝阳区建国路88号",  // 中文地址
            paymentMethod = "微信支付",  // 中文支付方式
            items = listOf(
                OrderItem(
                    id = 1,
                    productId = 101,
                    ...
                    image = "",
                    options = listOf(
                        ItemOption("辣度", "中辣"),  // 中文选项
                        ItemOption("米饭", "茉莉香米")  // 中文选项
                    )
                ),
                OrderItem(
                    id = 2,
            ...
            notes = "58MM打印机测试订单 - 包含中文内容测试",  // 中文备注
            woofoodInfo = WooFoodInfo(
                orderMethod = "外卖",  // 中文订单方式
                deliveryTime = "45-60分钟",  // 中文配送时间
                deliveryAddress = "北京市朝阳区建国路88号",  // 中文配送地址
                deliveryFee = "$5.00",
                tip = "$15.00",
                isDelivery = true
            ),
            ...
            discountTotal = "0.00",
            taxLines = listOf(
                TaxLine(1, "消费税", 10.0, "$7.50")  // 中文税费名称
            )
        )
    }
    ...
    private fun create80mmTestOrder(): Order {
        ...
        return Order(
            ...
            dateCreated = currentTime,
            total = "$164.48",
            customerName = "李四",  // 中文客户姓名
            contactInfo = "139-8765-4321",  // 中文电话号码
            billingInfo = "上海市浦东新区陆家嘴金融中心",  // 中文地址
            paymentMethod = "支付宝",  // 中文支付方式
            items = listOf(
                OrderItem(
                    id = 1,
                    productId = 201,
                    ...
                    image = "",
                    options = listOf(
                        ItemOption("辣度", "特辣"),  // 中文选项
                        ItemOption("豆腐", "嫩豆腐")  // 中文选项
                    )
                ),
                OrderItem(
                    id = 2,
                ...
                OrderItem(
                    ...
                    image = "",
                    options = listOf(
                        ItemOption("温度", "冰镇"),  // 中文选项
                        ItemOption("冰块", "正常")  // 中文选项
                    )
                )
            ),
            isPrinted = false,
            notificationShown = false,
            notes = "80MM热敏打印机综合测试订单。\n包含中文内容测试，包括对齐、格式化和切纸功能。\n如果此内容正确打印，说明您的打印机工作正常。",  // 中文备注
            woofoodInfo = WooFoodInfo(
                orderMethod = "外卖",  // 中文订单方式
                deliveryTime = "45-60分钟",  // 中文配送时间
                deliveryAddress = "上海市浦东新区陆家嘴金融中心",  // 中文配送地址
                deliveryFee = "$5.00",
                tip = "$15.00",
                isDelivery = true
            ),
            ...
            discountTotal = "10.00",
            taxLines = listOf(
                TaxLine(1, "增值税", 5.0, "$7.70"),  // 中文税费名称
                TaxLine(2, "消费税", 7.0, "$10.78")  // 中文税费名称
            )
        )
    }
    ...
    private fun createDefaultTestOrder(): Order {
        ...
        return Order(
            ...
            dateCreated = currentTime,
            total = "$65.00",
            customerName = "王五",  // 中文客户姓名
            contactInfo = "137-1234-5678",  // 中文电话号码
            billingInfo = "广州市天河区珠江新城",  // 中文地址
            paymentMethod = "银行卡",  // 中文支付方式
            items = listOf(
                OrderItem(
                    id = 1,
                    productId = 301,
            ...
            isPrinted = false,
            notificationShown = false,
            notes = "默认打印机测试订单，包含中文内容兼容性测试",  // 中文备注
            woofoodInfo = WooFoodInfo(
                orderMethod = "自取",  // 中文订单方式
                deliveryTime = null,
