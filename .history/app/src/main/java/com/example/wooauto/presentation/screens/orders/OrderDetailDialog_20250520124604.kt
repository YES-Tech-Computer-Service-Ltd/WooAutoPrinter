...
import com.example.wooauto.domain.models.LicenseStatus
import com.example.wooauto.licensing.LicenseStatus as LicensingLicenseStatus
...
fun OrderDetailDialog(
    ...
    val licenseManager = remember { viewModel.licenseManager }
        ...
        Card(
            ...
            Column(
                ...
                Box(
                    ...
                    // 如果证书无效，显示模糊层和提示
                    if (licenseInfo.status != LicensingLicenseStatus.VALID && licenseInfo.status != LicensingLicenseStatus.TRIAL) {
                        Box(
                            modifier = Modifier
                                .fillMaxSize()
                                .background(
                ...
                Row(
                    ...
                    Button(
                        ...
                        enabled = licenseInfo.status == LicensingLicenseStatus.VALID || licenseInfo.status == LicensingLicenseStatus.TRIAL
                    ) {
                        Icon(
