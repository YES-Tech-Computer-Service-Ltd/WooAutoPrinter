...
class MainActivity : ComponentActivity(), OrderNotificationManager.NotificationCallback {
    ...
    override fun onNewOrderReceived(order: Order, totalCount: Int) {
        ...
        currentPendingOrderCount = if (totalCount <= 0) 1 else totalCount
        ...
        Card(
            ...
            Column(
                ...
                Column(
                    ...
                    // 显示可能有多个订单的提示（动态数量）
                    val multiText = if (pendingCount > 1) "当前有 ${pendingCount} 个新订单待确认" else stringResource(R.string.multiple_orders_hint)
                    Text(
                        text = multiText,
