...
class DefaultOrderPrintTemplate @Inject constructor(
    ...
    private fun create80mmTestOrder(): Order {
        ...
        return Order(
            ...
            billingInfo = "商业大道123号，100单元，商业区，ST 12345",
            paymentMethod = "信用卡",
            items = listOf(
                OrderItem(
                    id = 1,
            ...
            isPrinted = false,
            notificationShown = false,
            notes = "80mm热敏打印机综合测试订单。\n正在测试所有打印功能，包括对齐、格式化和切纸。\n如果此订单打印正确，您的打印机工作正常。",
            woofoodInfo = WooFoodInfo(
                orderMethod = "配送",
                deliveryTime = "45-60分钟",
                deliveryAddress = "商业大道123号，100单元，商业区，ST 12345",
                deliveryFee = "$5.00",
                tip = "$15.00",
                isDelivery = true
            ),
            ...
            discountTotal = "10.00",
            taxLines = listOf(
                TaxLine(1, "消费税", 5.0, "$7.70"),
                TaxLine(2, "省税", 7.0, "$10.78")
            )
        )
    }
