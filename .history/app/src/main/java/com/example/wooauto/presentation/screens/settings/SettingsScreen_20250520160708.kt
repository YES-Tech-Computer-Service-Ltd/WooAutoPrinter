...
fun SettingsScreen(
    ...
    val isAutoPrintEnabled by viewModel.isAutoPrintEnabled.collectAsState()
                        ...
                        SettingsNavigationItem(
                            ...
                            subTitle = run {
                                ...
                                if (isAutoPrintEnabled) {
                                    val templateName = templates.find { it.id == selectedTemplateId }?.name ?: noTemplateSelectedText
