...
}/** * 订单商品列表 */@Composablefun OrderItemsList(items: List<OrderItem>, currencySymbol: String) {    Column(        modifier = Modifier            .fillMaxWidth()    ) {        items.forEach { item ->            OrderItemRow(item = item, currencySymbol = currencySymbol)
