...
data class CrashData(
    ...
    companion object {
        ...
        fun fromJson(jsonString: String): CrashData {
            ...
            val appState = mutableMapOf<String, String>()
            if (json.has("app_state")) {
                ...
                while (appStateKeys.hasNext()) {
                    ...
                    appState[key] = appStateJson.getString(key)
                }
            }
            ...
            return CrashData(
                ...
                contextLogs = json.optString("context_logs", ""),
                userActions = json.optString("user_actions", ""),
                appState = appState,
                performanceData = json.optString("performance_data", "")
            )
        }
    }
}
