                ...
                0 -> {
                    ...
                    if (isLoading) {
                        ...
                        currentConfig?.let { config ->
                            ...
                            val paperWidth = remember { mutableStateOf(80) } // 默认80mm
                            
                            LaunchedEffect(Unit) {
                                try {
                                    val printerConfig = settingsViewModel.getDefaultPrinterConfig()
                                    paperWidth.value = printerConfig?.paperWidth ?: 80
                                } catch (e: Exception) {
                                    paperWidth.value = 80 // 默认值
                                }
                            }
