        ...
        TemplateSelectorDialog(
            ...
            onTemplateSelected = { templateId ->
                ...
                val templateType = when (templateId) {
                    ...
                    else -> TemplateType.FULL_DETAILS // 自定义模板默认使用FULL_DETAILS类型
                }
...
fun TemplateSelectorDialog(
    ...
    // 准备显示的模板选项（默认 + 自定义）
    val templateOptions = remember(allConfigs) {
        val defaultTemplates = listOf(
            Triple("full_details", stringResource(R.string.full_details_template), Icons.AutoMirrored.Filled.Article),
            Triple("delivery", stringResource(R.string.delivery_template), Icons.Default.LocalShipping),
            Triple("kitchen", stringResource(R.string.kitchen_template), Icons.Default.Restaurant)
        )
