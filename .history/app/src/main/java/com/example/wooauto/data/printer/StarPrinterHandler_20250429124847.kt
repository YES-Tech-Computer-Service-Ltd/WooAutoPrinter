...
class StarPrinterHandler(private val context: Context) {
    companion object {
        ...
        // TSP100专用命令
        private const val CMD_TSP100_RESET = "\u001b\u0040\u001b\u0052\u0008\u001b\u001e\u0046\u001b\u001e\u0042\u0001\u001b\u001e\u0043"  // 完整的TSP100III重置序列
        private const val CMD_TSP100_INIT = "\u001b\u0040\u001b\u0061\u0000\u001b\u0052\u0008"   // 初始化并左对齐
        private const val CMD_TSP100_ENCODING = "\u001b\u0052\u0008"            // 设置字符集（UTF-8）
        private const val CMD_TSP100_CLEAR = "\u0018"                           // CAN - 清除缓冲区
        private const val CMD_TSP100_FEED = "\u001b\u0064\u0003"               // 走纸3行
        private const val CMD_TSP100_CUT = "\u001b\u0064\u0000"                // TSP100专用切纸命令
    }
