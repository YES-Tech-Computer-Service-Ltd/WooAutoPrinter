...
class StarPrinterHandler(private val context: Context) {
    companion object {
        ...
        // TSP100专用命令
        private const val CMD_TSP100_RESET = "\u001b\u0040\u001b\u0052\u0008\u001b\u001e\u0046\u001b\u001e\u0042\u0001\u001b\u001e\u0043\u001b\u0074\u0001"  // 完整的TSP100III重置序列
        private const val CMD_TSP100_INIT = "\u001b\u0040\u001b\u0061\u0000\u001b\u0052\u0008\u001b\u0074\u0001"   // 初始化并左对齐
        private const val CMD_TSP100_ENCODING = "\u001b\u0052\u0008\u001b\u0074\u0001"            // 设置字符集（UTF-8）
        private const val CMD_TSP100_CLEAR = "\u0018\u001b\u0040"                           // CAN + 初始化
        private const val CMD_TSP100_FEED = "\u001b\u0064\u0005"               // 走纸5行
        private const val CMD_TSP100_CUT = "\u001b\u0064\u0000\u001d\u0056\u0001"                // TSP100专用切纸命令
    }
    ...
    suspend fun printText(content: String): Boolean {
        ...
        try {
            ...
            // 检查是否是TSP100系列
            if (isTSP100Series) {
                Log.d(TAG, "$logPrefix 检测到TSP100系列打印机，使用专用打印流程")
                return printTSP100(content)
            }
            ...
            Log.e(TAG, "$logPrefix 打印失败: ${e.message}", e)
            return false
        }
    }
        ...
        try {
            ...
            withContext(Dispatchers.IO) {
                ...
                try {
                    ...
                    currentPrinter?.printAsync(CMD_TSP100_CLEAR)?.await() // CAN
                    delay(300L)
                } catch (e: Exception) {
    ...
    private suspend fun printTSP100(content: String): Boolean {
        ...
        try {
            ...
            val endingCommands = StringBuilder()
                .append("\n")                  // 换行
                .append(CMD_TSP100_FEED)       // 走纸
                .append(CMD_TSP100_CUT)        // TSP100专用切纸命令
                .toString()
