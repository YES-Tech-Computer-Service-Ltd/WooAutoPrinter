        ...
        return Order(
            ...
            items = listOf(
                Order.OrderItem(
                    ...
                    price = 19.00,
                    options = listOf(
                        Order.OrderOption("Spice Level", "Medium"),
                        Order.OrderOption("Rice", "Jasmine")
                    )
                ),
                Order.OrderItem(
                    id = 2,
        ...
        return Order(
            ...
            items = listOf(
                Order.OrderItem(
                    ...
                    price = 45.00,
                    options = listOf(
                        Order.OrderOption("Side dishes", "Rice, Vegetables, Soup"),
                        Order.OrderOption("Spice Level", "Mild")
                    )
                ),
                Order.OrderItem(
                    id = 2,
                    ...
                    options = listOf(
                        Order.OrderOption("Spice level", "Medium"),
                        Order.OrderOption("Oil", "Less oil")
                    )
                ),
                Order.OrderItem(
                    id = 3,
                ...
                Order.OrderItem(
                    ...
                    price = 8.00,
                    options = listOf(
                        Order.OrderOption("Temperature", "Cold"),
                        Order.OrderOption("Ice", "Normal")
                    )
                )
            ),
            taxLines = listOf(
                Order.TaxLine("GST", "5.0", "$7.70"),
                Order.TaxLine("PST", "7.0", "$10.78")
            ),
            woofoodInfo = Order.WoofoodInfo(
                isDelivery = true,
