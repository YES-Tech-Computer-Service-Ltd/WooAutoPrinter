...
fun TemplateSettings(
    ...
    Column(
        ...
        if (config.showStoreInfo && hasStoreInfo) {
            SettingCheckbox(
                label = stringResource(R.string.template_store_name),
            ...
            SettingCheckbox(
                label = stringResource(R.string.template_store_address), 
            ...
            SettingCheckbox(
                label = stringResource(R.string.template_store_phone),
