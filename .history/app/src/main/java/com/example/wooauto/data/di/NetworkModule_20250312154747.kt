...
import com.example.wooauto.data.remote.interceptors.ConnectionResetHandler
...
class NetworkModule {
    ...
    companion object {
        ...
        @Provides
        @Singleton
        fun provideNetworkStatusInterceptor(context: Context): NetworkStatusInterceptor {
        ...
        @Provides
        @Singleton
        fun provideWooCommerceApi(config: WooCommerceConfig, sslErrorInterceptor: SSLErrorInterceptor): WooCommerceApi {
            // 初始化元数据处理器注册表
            ...
            return WooCommerceApiImpl(remoteConfig, sslErrorInterceptor)
        }
