...
data class TemplateConfig(
    ...
    // 样式：名称/地址/电话各自独立
    val styleStoreNameBold: Boolean = true,
    val styleStoreNameLarge: Boolean = true,
    val styleStoreAddressBold: Boolean = false,
    val styleStoreAddressLarge: Boolean = false,
    val styleStorePhoneBold: Boolean = false,
    val styleStorePhoneLarge: Boolean = false,
    ...
    // 样式：订单号/日期独立
    val styleOrderNumberBold: Boolean = false,
    val styleOrderNumberLarge: Boolean = false,
    val styleOrderDateBold: Boolean = false,
    val styleOrderDateLarge: Boolean = false,
    ...
    // 样式：姓名/电话独立
    val styleCustomerNameBold: Boolean = false,
    val styleCustomerNameLarge: Boolean = false,
    val styleCustomerPhoneBold: Boolean = false,
    val styleCustomerPhoneLarge: Boolean = false,
    ...
    // 样式：菜品名称/右侧数量x价格独立
    val styleItemNameBold: Boolean = true,
    val styleItemNameLarge: Boolean = true,
    val styleQtyPriceBold: Boolean = true,
    val styleQtyPriceLarge: Boolean = true,
    
    // === 支付信息 ===
    // 是否显示支付信息
    val showPaymentInfo: Boolean = true,
    // 样式
    val stylePaymentMethodBold: Boolean = false,
    val stylePaymentMethodLarge: Boolean = false,
    
    // === 页脚 ===
    // 是否显示页脚
    val showFooter: Boolean = true,
    // 样式
    val styleFooterBold: Boolean = false,
    val styleFooterLarge: Boolean = false,
    ...
    companion object {
        ...
        private fun createFullDetailsConfig(templateId: String): TemplateConfig {
            return TemplateConfig(
                ...
                showStorePhone = true,
                styleStoreNameBold = true,
                styleStoreNameLarge = true,
                styleStoreAddressBold = false,
                styleStoreAddressLarge = false,
                styleStorePhoneBold = false,
                styleStorePhoneLarge = false,
                showOrderInfo = true,
                showOrderNumber = true,
                showOrderDate = true,
                styleOrderNumberBold = false,
                styleOrderNumberLarge = false,
                styleOrderDateBold = false,
                styleOrderDateLarge = false,
                showCustomerInfo = true,
                showCustomerName = true,
                showCustomerPhone = true,
                showDeliveryInfo = true,
                styleCustomerNameBold = false,
                styleCustomerNameLarge = false,
                styleCustomerPhoneBold = false,
                styleCustomerPhoneLarge = false,
                showOrderContent = true,
                showItemDetails = true,
                showItemPrices = true,
                showOrderNotes = true,
                showTotals = true,
                styleItemNameBold = true,
                styleItemNameLarge = true,
                styleQtyPriceBold = true,
                styleQtyPriceLarge = true,
                showPaymentInfo = true,
                stylePaymentMethodBold = false,
                stylePaymentMethodLarge = false,
                showFooter = true,
                styleFooterBold = false,
                styleFooterLarge = false,
        ...
        private fun createDeliveryConfig(templateId: String): TemplateConfig {
            return TemplateConfig(
                ...
                showStoreAddress = true,
                showStorePhone = true,
                styleStoreInfoBold = true,
                styleStoreInfoLarge = true,
                showOrderInfo = true,
                showOrderNumber = true,
                showOrderDate = true,
                styleOrderInfoBold = false,
                styleOrderInfoLarge = false,
                showCustomerInfo = true,
                showCustomerName = true,
                showCustomerPhone = true,
                showDeliveryInfo = true,
                styleCustomerInfoBold = false,
                styleCustomerInfoLarge = false,
                showOrderContent = true,
                showItemDetails = true,
                showItemPrices = true,
                showOrderNotes = true,
                showTotals = true,
                styleOrderContentBold = true,
                styleOrderContentLarge = true,
                showPaymentInfo = true,
                stylePaymentInfoBold = false,
                stylePaymentInfoLarge = false,
                showFooter = true,
                styleFooterBold = false,
                styleFooterLarge = false,
        ...
        private fun createKitchenConfig(templateId: String): TemplateConfig {
            return TemplateConfig(
                ...
                styleStoreInfoBold = false,
                styleStoreInfoLarge = false,
                showOrderInfo = true,
                showOrderNumber = true,
                showOrderDate = true,
                styleOrderInfoBold = false,
