...
fun WooAppBar(
    ...
    CenterAlignedTopAppBar(
        ...
        windowInsets = TopAppBarDefaults.windowInsets.asPaddingValues()
            .let { PaddingValues(start = it.calculateStartPadding(layoutDirection),
                        end = it.calculateEndPadding(layoutDirection),
                        top = it.calculateTopPadding() * 0.7f,
                        bottom = it.calculateBottomPadding() * 0.7f) }
    )
}
