...
class StarPrinterHandler(private val context: Context) {
                ...
                DocumentBuilder()
                    .addPrinter(
                        PrinterBuilder().apply {
                            ...
                            // 打印二维码
                            actionPrintQRCode(
                                com.starmicronics.stario10.starxpandcommand.printer.QRCodeParameter(
                                    content
                                ).apply {
                                    setCellSize(cellSize)
                                    setLevel(com.starmicronics.stario10.starxpandcommand.printer.QRCodeLevel.M)
                                }
                            )
    ...
    suspend fun printBarcode(
        content: String,
        symbology: com.starmicronics.stario10.starxpandcommand.printer.BarcodeSymbology = 
            com.starmicronics.stario10.starxpandcommand.printer.BarcodeSymbology.Code128
    ): Boolean {
        val logPrefix = "【打印条形码】"
        try {
            if (currentPrinter == null) {
                ...
                DocumentBuilder()
                    .addPrinter(
                        PrinterBuilder().apply {
                            ...
                            // 打印条形码
                            actionPrintBarcode(
                                com.starmicronics.stario10.starxpandcommand.printer.BarcodeParameter(
                                    content,
                                    symbology
                                ).apply {
                                    setHeight(5.0)  // 设置高度
