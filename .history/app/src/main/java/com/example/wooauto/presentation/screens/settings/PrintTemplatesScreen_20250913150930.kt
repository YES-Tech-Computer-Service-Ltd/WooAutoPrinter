...
import com.example.wooauto.presentation.screens.templatePreview.TemplatePreviewScreen.TemplatePreviewDialogContent
import com.example.wooauto.presentation.screens.templatePreview.TemplateConfigViewModel
import com.example.wooauto.domain.templates.TemplateType

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PrintTemplatesInnerScreen() {
    // 二级页面版本：使用 SettingsSubPageScaffold，无对话框
    SettingsSubPageScaffold() {
        PrintTemplatesPageContent()
    }
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun PrintTemplatesPageContent(
    ...
    // 预览改为跳转至现有 TemplatePreviewScreen（已是独立路由）
        ...
        items(templates) { template ->
            TemplateItem(
                ...
                onClick = {
                    ...
                    // 进入模板预览/编辑二级路由
                    // 交由外层导航：settings/printing/templates -> template_preview/{id}
                    // 这里直接使用 TemplatePreviewScreen 的路由
                    com.example.wooauto.presentation.navigation.Screen.TemplatePreview
                },
                onEdit = {
                    // 进入模板预览/编辑
                    com.example.wooauto.presentation.navigation.Screen.TemplatePreview
